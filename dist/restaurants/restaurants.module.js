...
RestaurantsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([restaurants_entity_1.Restaurant])],
        providers: [restaurants_resolver_1.RestaurantsResolver, restaurants_service_1.RestaurantService]
    })
], RestaurantsModule);
